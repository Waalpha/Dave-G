...
import { AlertTriangle, Globe, ArrowLeft, Building2, HelpCircle, ShieldAlert } from 'lucide-react';
      ...
      <div className="max-w-lg w-full bg-slate-900 border border-slate-800 rounded-3xl p-8 sm:p-10 text-center shadow-2xl space-y-6 relative overflow-hidden">
        ...
        <div className="space-y-2">
          <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-slate-800 border border-slate-700 text-slate-300 text-xs font-semibold">
            ...
            <span>Multi-Tenant Domain Resolution</span>
          </div>
          <h1 className="text-2xl sm:text-3xl font-extrabold text-white tracking-tight">
            Tenant Not Found
          </h1>
          <p className="text-sm text-slate-400 max-w-md mx-auto leading-relaxed">
            No active organization workspace or public website exists for the subdomain:
          </p>
          {attemptedSlug && (
        ...
        <div className="bg-slate-950/60 rounded-2xl p-4 border border-slate-800/80 text-left text-xs text-slate-400 space-y-2">
          ...
          <ul className="list-disc pl-5 space-y-1 text-slate-400">
            <li>The organization slug may be misspelled in the browser address bar.</li>
            <li>The organization may have been deactivated or permanently removed.</li>
            <li>DNS propagation or custom domain assignment may be in progress.</li>
          </ul>
        </div>
        ...
        <div className="pt-2 flex flex-col sm:flex-row items-center justify-center gap-3">
          ...
          >
            ...
            <span>Davetech ERP Main Website</span>
          </button>
          <a
        ...
        <div className="pt-4 border-t border-slate-800/80 text-[11px] text-slate-400">
          Powered by <strong className="text-slate-200">Davetech Cloud ERP Platform</strong> • High-Isolation SaaS Architecture
        </div>
      </div>
    </div>
  );
